...
class Descriptors:
    ...
    marker_set_description: Dict[str, Marker_set_description] = field(
        init=False, default_factory=dict
    )
    rigid_body_description: Dict[int, Rigid_body_description] = field(
        init=False, default_factory=dict
    )
    skeleton_description: Dict[int, Skeleton_description] = field(
        init=False, default_factory=dict
    )
    force_plate_description: Dict[str, Force_plate_description] = field(
        init=False, default_factory=dict
    )
    device_description: Dict[str, Device_description] = field(
        init=False, default_factory=dict
    )
    camera_description: Dict[str, Camera_description] = field(
        init=False, default_factory=dict
    )
    asset_description: Dict[int, Asset_description] = field(
        init=False, default_factory=dict
    )